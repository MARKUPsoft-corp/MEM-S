...
const chemisesProducts = computed(() => allProducts.value.filter(p => getCategorySlug(p) === 'chemises-lin'))
const pantalonsProducts = computed(() => allProducts.value.filter(p => getCategorySlug(p) === 'pantalons-lin'))
