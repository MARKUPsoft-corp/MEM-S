            ...
            <div class="profile-card">
                ...
                <form @submit.prevent="handleUpdateProfile" class="form">
                    ...
                    <div v-if="authStore.isAdmin" class="mb-3">
                        <NuxtLink to="/admin" class="btn btn-dark w-100 py-2 d-flex align-items-center justify-content-center gap-2 text-decoration-none">
                            <i class="bi bi-speedometer2 text-gold"></i>
                            <span class="fw-semibold">Accéder au Tableau de Bord Administrateur</span>
                        </NuxtLink>
                    </div>
